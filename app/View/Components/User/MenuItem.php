        ...
        return <<<'BLADE'
                ...
                <li>
                    <a x-data
                        {{
                            $attributes->class([
                                "hover:text-inherit whitespace-nowrap mr-2 ",
                                "mary-active-menu $activeBgColor" => ($active || ($activateByRoute && $routeMatches()))
                            ])
                        }}
                        :class="collapsed ? 'flex flex-col my-0.5 py-1.5 px-0 !gap-0' : 'flex my-0.5 py-1.5 px-4'"
                    ...
                    >
                        ...
                        <span :class="collapsed ? 'text-xs' : 'text-sm'">
                            @if($title)
                                {{ $title }}
