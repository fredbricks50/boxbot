...
<div class="w-full max-w-md p-8 space-y-6">
    ...
    <div class="flex flex-row w-full">
        <x-form wire:submit="loginuser" class="w-full gap-5" no-separator>
            ...
            <p class="text-center text-sm text-gray-400">Forgot password? <a wire:navigate href="{{ route('user.auth.forgotpassword') }}" class="text-blue-500 hover:underline">Reset Password</a></p>
            <p class="text-center text-lg text-gray-400">Don't have an account? <a wire:navigate href="{{ route('user.auth.register') }}" class="text-blue-500 hover:underline">Sign Up</a></p>
            <x-slot:actions>
                <x-button label="Login" class="btn-primary w-full" type="submit" spinner="loginuser" />
            </x-slot:actions>
        </x-form>
    </div>
